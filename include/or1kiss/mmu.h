...
#define OR1KISS_PAGE_BOUNDARY(addr) (OR1KISS_PAGE_ALIGN((addr) + \
                                     OR1KISS_PAGE_SIZE))
...
#define OR1KISS_TLB_MAX_REGS        (2 * OR1KISS_TLB_MAX_SETS * \
                                     OR1KISS_TLB_MAX_WAYS)

#define OR1KISS_TLB_MR(way, set)    ((way) * OR1KISS_TLB_MAX_SETS * 2 + set)
#define OR1KISS_TLB_TR(way, set)    (OR1KISS_TLB_MR(way, set) + \
                                     OR1KISS_TLB_MAX_SETS)
...
namespace or1kiss {
    ...
    public:
        ...
        inline u32 get_num_sets() const { return m_num_sets; }

        inline u32 get_cfgr() const { return m_cfg; }
        inline u32 get_cr()   const { return m_ctrl; }
        inline u32 get_pr()   const { return m_prot; }
