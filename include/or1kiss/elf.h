...
public:
    ...
    inline u64 offset(u64 addr) const { return addr - m_virt_addr; }

    inline u64 to_phys(u64 addr) const { return offset(addr) + m_phys_addr; }
...
public:
    ...
    inline const vector<elf_symbol*>& get_symbols() const { return m_symbols; }
