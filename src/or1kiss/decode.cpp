...
static opcode decode_alu(u32 insn) {
    ...
    if (opcode1 == 0x0) {
        ...
        case 0x8:
            return ORBIS32_SLL;
        case 0xc:
            return ORBIS32_EXTHS;
        case 0xd:
            return ORBIS32_EXTWS;
        default:
            return INVALID_OPCODE;
        }
    } else if (opcode1 == 0x1) {
        ...
        case 0x8:
            return ORBIS32_SRL;
        case 0xc:
            return ORBIS32_EXTBS;
        case 0xd:
            return ORBIS32_EXTWZ;
        default:
            return INVALID_OPCODE;
        }
    } else if (opcode1 == 0x2) {
...
static opcode decode_fpx(u32 insn) {
    ...
    default:
        switch (opcode >> 4) {
        case 0xd:
            return ORFPX32_CUST1;
        case 0xe:
            return ORFPX64_CUST1;
        default:
            break;
        }
...
opcode decode(u32 insn) {
    ...
    case 0x06:
        return decode_util(insn);
    case 0x2e:
        return decode_shift(insn);
    case 0x31:
        return decode_mac(insn);
    case 0x32:
        return decode_fpx(insn);
    ...
    case 0x09:
        return ORBIS32_RFE;
    case 0x2d:
        return ORBIS32_MFSPR;
    case 0x30:
        return ORBIS32_MTSPR;
    case 0x13:
        return ORBIS32_MACI;

    // Custom instructions
    case 0x1c:
        return ORBIS32_CUST1;
    case 0x1d:
        return ORBIS32_CUST2;
    case 0x1e:
        return ORBIS32_CUST3;
    case 0x1f:
        return ORBIS32_CUST4;
    case 0x3c:
        return ORBIS32_CUST5;
    case 0x3d:
        return ORBIS32_CUST6;
    case 0x3e:
        return ORBIS32_CUST7;
    case 0x3f:
        return ORBIS32_CUST8;
    default:
        break;
    }
    ...
    case 0x5e0:
        return ORBIS32_SFEQI;
    case 0x5e1:
        return ORBIS32_SFNEI;
    case 0x5e2:
        return ORBIS32_SFGTUI;
    case 0x5e3:
        return ORBIS32_SFGEUI;
    case 0x5e4:
        return ORBIS32_SFLTUI;
    case 0x5e5:
        return ORBIS32_SFLEUI;
    case 0x5ea:
        return ORBIS32_SFGTSI;
    case 0x5eb:
        return ORBIS32_SFGESI;
    case 0x5ec:
        return ORBIS32_SFLTSI;
    case 0x5ed:
        return ORBIS32_SFLESI;
    case 0x720:
        return ORBIS32_SFEQ;
    case 0x721:
        return ORBIS32_SFNE;
    case 0x722:
        return ORBIS32_SFGTU;
    case 0x723:
        return ORBIS32_SFGEU;
    case 0x724:
        return ORBIS32_SFLTU;
    case 0x725:
        return ORBIS32_SFLEU;
    case 0x72a:
        return ORBIS32_SFGTS;
    case 0x72b:
        return ORBIS32_SFGES;
    case 0x72c:
        return ORBIS32_SFLTS;
    case 0x72d:
        return ORBIS32_SFLES;
    default:
        break;
    }
    ...
    switch (insn) {
    case 0x22000000:
        return ORBIS32_MSYNC;
    case 0x23000000:
        return ORBIS32_CSYNC;
    case 0x22800000:
        return ORBIS32_PSYNC;
    default:
        break;
    }
...
void or1k::decode_orbis32_mtspr(instruction* ci) {
    ...
    u32 k = (bits32(m_insn, 25, 21) << 11) | (bits32(m_insn, 10, 0) << 0);
...
void or1k::decode_orbis32_swa(instruction* ci) {
    u32 a = bits32(m_insn, 20, 16);
    u32 b = bits32(m_insn, 15, 11);
    u32 i = (bits32(m_insn, 25, 21) << 11) | (bits32(m_insn, 10, 0) << 0);
...
void or1k::decode_na(instruction* ci) {
    OR1KISS_ERROR("Instruction 0x%08x at address 0x%08x not supported", m_insn,
                  m_next_pc);
}
